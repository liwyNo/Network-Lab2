...
tl1 :: TCPRouter(IPHEADER 1)
tl2 :: TCPRouter(IPHEADER 1)
//file::FileApp(SEND "/home/comnetsii/test/infile.txt", RECV "/home/comnetsii/test/outfile.txt");
RatedSource(DATA "123456", RATE 1) -> [0] tcp1 [1] -> Print(From1, -1) -> SetIPHeader(SOURCE_IP 1, DEST_IP 2) -> [1]tl1[0] -> [0] r1 [0] -> [0]tl1[1] -> Print(TO1) -> [1] tcp1 [0] -> Discard
